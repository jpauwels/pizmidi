...
void StandaloneFilterWindow::showAudioSettingsDialog()
{
    AudioDeviceSelectorComponent selectorComp (*deviceManager,
                                               ...
                                               filter->getNumOutputChannels(),
                                               filter->getNumOutputChannels(),
                                               JucePlugin_WantsMidiInput==1, JucePlugin_ProducesMidiOutput==1, true, false);

    selectorComp.setSize (500, 450);

    DialogWindow::showModalDialog (
		(filter->getNumInputChannels()||filter->getNumOutputChannels())?TRANS("Audio/MIDI Settings"):TRANS("MIDI Settings"), &selectorComp, this, Colours::lightgrey, true, false, false);
}
...
void StandaloneFilterWindow::buttonClicked (Button*)
{
    ...
    PopupMenu m;
    m.addItem (1, (filter->getNumInputChannels()||filter->getNumOutputChannels())?TRANS("Audio/MIDI Settings..."):TRANS("MIDI Settings..."));
    m.addSeparator();
