...
*/
#define JucePlugin_Name                     "AudioToCC"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "Converts audio amplitude to midi CC messages"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'A2CC'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           AudioToCCAU

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "AudioToCCAU"
#define JucePlugin_AUCocoaViewClassName		audiotoccAU_V1
...
*/
#define JucePlugin_CFBundleIdentifier       "org.thepiz.AudioToCC"
